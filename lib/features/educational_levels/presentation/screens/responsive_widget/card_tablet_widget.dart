...
class CardEducationalLevelsTabletWidget extends StatelessWidget {
  final int index;
  final double? height;
  final double? width;

  const CardEducationalLevelsTabletWidget({
    super.key,
    required this.index,
    this.height,
    this.width,
      ...
      child: IntrinsicHeight(
        child: Column(
          children: [
            Expanded(
              flex: 5,
              child: ImageWidget(width: width, imagePath: 'https://images.pexels.com/photos/13650913/pexels-photo-13650913.jpeg?auto=compress&cs=tinysrgb&w=600',),
            ),
            Expanded(
                flex: 4,
                child: Padding(
