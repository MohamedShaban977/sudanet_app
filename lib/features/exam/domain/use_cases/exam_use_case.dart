...
class GetExamReadyUseCases
    implements UseCase<BaseResponseEntity<ExamReadyEntity>, String> {
  final ExamRepository repository;

  GetExamReadyUseCases({required this.repository});

  @override
  Future<Either<Failure, BaseResponseEntity<ExamReadyEntity>>> call(
          String id) =>
      repository.getExamReady(id);
}

class GetExamQuestionOrPercentageUseCases
    implements UseCase<BaseResponseEntity<ExamEntity>, String> {
  final ExamRepository repository;

  GetExamQuestionOrPercentageUseCases({required this.repository});

  @override
  Future<Either<Failure, BaseResponseEntity<ExamEntity>>> call(String id) =>
      repository.getExamQuestionOrPercentage(id);
}

class SaveAnswerUseCases
    implements UseCase<BaseResponseEntity<bool>, SaveAnswerRequest> {
  final ExamRepository repository;
