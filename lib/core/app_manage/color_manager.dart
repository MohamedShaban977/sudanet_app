...
class ColorManager {
  ...
  static const Color primary = Color(0xff0000CE);
  static const Color secondary =  Color(0xffFF8E42);
  static const Color textGray =  Color(0xff032326);
 ...
 //  static Color hintText = const Color(0xffFFFFFF);
